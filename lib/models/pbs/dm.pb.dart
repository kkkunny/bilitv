...
class ClickButtonV2 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set renderType($core.int value) => $_setSignedInt32(4, value);
  @$pb.TagNumber(5)
  $core.bool hasRenderType() => $_has(4);
  @$pb.TagNumber(5)
  void clearRenderType() => $_clearField(5);
  ...
  @$pb.TagNumber(8)
  set exposureType($core.int value) => $_setSignedInt32(7, value);
  @$pb.TagNumber(8)
...
class CommandDm extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set mid($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
...
class DmSegMobileReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<DmColorful>(5, _omitFieldNames ? '' : 'colorfulSrc',
        protoName: 'colorfulSrc', subBuilder: DmColorful.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  $pb.PbList<DmColorful> get colorfulSrc => $_getList(3);
}
...
class DmViewReply extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set checkBox($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
...
class DmWebViewReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<CommandDm>(9, _omitFieldNames ? '' : 'commandDms',
        protoName: 'commandDms', subBuilder: CommandDm.create)
...
class LabelV2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(4, _omitFieldNames ? '' : 'exposureType')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set exposureType($core.int value) => $_setSignedInt32(3, value);
  @$pb.TagNumber(4)
...
class PostPanelV2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(10, _omitFieldNames ? '' : 'postStatus')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set bizType($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(10)
  set postStatus($core.int value) => $_setSignedInt32(9, value);
  @$pb.TagNumber(10)
...
class DMApi {
  ...
  $async.Future<DmSegMobileReply> dmSegMobile(
      ...
      _client.invoke<DmSegMobileReply>(
          ctx, 'DM', 'DmSegMobile', request, DmSegMobileReply());

  /// 客户端弹幕元数据 字幕、分段、防挡蒙版等
  $async.Future<DmViewReply> dmView(
          $pb.ClientContext? ctx, DmViewReq request) =>
  ...
  $async.Future<Response> dmPlayerConfig(
      ...
      _client.invoke<Response>(
          ctx, 'DM', 'DmPlayerConfig', request, Response());

  /// ott弹幕列表
  $async.Future<DmSegOttReply> dmSegOtt(
          $pb.ClientContext? ctx, DmSegOttReq request) =>
      _client.invoke<DmSegOttReply>(
          ctx, 'DM', 'DmSegOtt', request, DmSegOttReply());

  /// SDK弹幕列表
  $async.Future<DmSegSDKReply> dmSegSDK(
          $pb.ClientContext? ctx, DmSegSDKReq request) =>
      _client.invoke<DmSegSDKReply>(
          ctx, 'DM', 'DmSegSDK', request, DmSegSDKReply());
  $async.Future<DmExpoReportRes> dmExpoReport(
          $pb.ClientContext? ctx, DmExpoReportReq request) =>
      _client.invoke<DmExpoReportRes>(
          ctx, 'DM', 'DmExpoReport', request, DmExpoReportRes());
}
